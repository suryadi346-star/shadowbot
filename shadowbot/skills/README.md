...
This directory contains built-in skills that extend shadowbot's capabilities.
...
When skills reference large local documentation or logs, prefer shadowbot's built-in
