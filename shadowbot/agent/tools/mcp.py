"""MCP client: connects to MCP servers and wraps their tools as native shadowbot tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a shadowbot Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only shadowbot Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only shadowbot Tool."""
