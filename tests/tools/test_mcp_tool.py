...
from shadowbot.agent.tools.mcp import (
    MCPResourceWrapper,
    MCPPromptWrapper,
    MCPToolWrapper,
    connect_mcp_servers,
...
from shadowbot.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("shadowbot.agent.tools.mcp.logger.warning", _warning)
...
async def test_connect_mcp_servers_logs_stdio_pollution_hint(
    ...
    monkeypatch.setattr("shadowbot.agent.tools.mcp.logger.error", _error)
