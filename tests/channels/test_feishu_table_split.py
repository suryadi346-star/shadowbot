...
table, allowing shadowbot to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from shadowbot.channels import feishu
...
from shadowbot.channels.feishu import FeishuChannel
