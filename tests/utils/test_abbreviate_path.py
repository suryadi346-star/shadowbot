...
import os
from shadowbot.utils.path import abbreviate_path
...
class TestAbbreviatePathWindows:
    def test_windows_drive_path(self):
        path = "D:\\Documents\\GitHub\\shadowbot\\src\\utils\\helpers.py"
    ...
    def test_windows_home(self):
        home = os.path.expanduser("~")
        path = os.path.join(home, ".shadowbot", "workspace", "log.txt")
