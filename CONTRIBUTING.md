# Contributing to shadowbot

Thank you for being here.

shadowbot is built with a simple belief: good tools should feel calm, clear, and humane.
...
# Lint code
ruff check shadowbot/

# Format code
ruff format shadowbot/
```

## Code Style

We care about more than passing lint. We want shadowbot to stay small, calm, and readable.
...
Please feel free to open an [issue](https://github.com/suryadi346-satr/shadowbot/issues), join the community, or simply reach out:

- 
- 
- 

Thank you for spending your time and care on shadowbot. We would love for more people to participate in this community, and we genuinely welcome contributions of all sizes.
